...
def test_service_worker_controls_the_app_shell(app, client):
    ...
    assert b"timemanager-shell-v9" in response.data
    assert b"/static/styles.css?v=9" in response.data
    assert b"/static/app.js?v=9" in response.data
    ...
    assert b"/static/styles.css?v=9" in offline.data
